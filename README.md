...
```
bash <(curl -Ls https://raw.githubusercontent.com/rocloudcc/3x-ui/master/install.sh)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/rocloudcc/3x-ui/master/install.sh) v1.7.8
```
